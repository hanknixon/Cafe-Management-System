...
public class EditFood2 extends JFrame implements ActionListener
{
	...
	EditFood2()
	{
        ...
        panel.setBorder(BorderFactory.createTitledBorder(border, "ADD SNACKS"));
	...
	public void actionPerformed(ActionEvent e) {
	    if (e.getSource() == add) {
	        ...
	        if (productId.isEmpty() || productName.isEmpty() || productDesc.isEmpty() || productPrice.isEmpty() || !productId.startsWith("EID")) {
	        ...
	        try {
	            ...
	            String query = "insert into food values('" + productId + "', '" + productName + "', '" + productDesc + "', '" + productPrice + "')";
