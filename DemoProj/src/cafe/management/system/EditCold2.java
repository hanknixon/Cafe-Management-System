...
public class EditCold2 extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) {
	    if (e.getSource() == add) {
	        ...
	        if (productId.isEmpty() || productName.isEmpty() || productDesc.isEmpty() || productPrice.isEmpty() || !productId.startsWith("CID")) {
	        ...
	        try {
	            ...
	            String query = "insert into colddrinksmenu values('" + productId + "', '" + productName + "', '" + productDesc + "', '" + productPrice + "')";
