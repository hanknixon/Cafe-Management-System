...
public class HotDrinks1 extends JFrame implements ActionListener {
    ...
    HotDrinks1() {
        ...
        try {
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select HOT_DRINKS_AVAILABLE,Description,Price from hotdrinksmenu");
