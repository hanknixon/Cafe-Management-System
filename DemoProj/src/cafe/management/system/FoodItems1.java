...
public class FoodItems1 extends JFrame implements ActionListener {
    ...
    FoodItems1() {
        ...
        try {
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select SNACKS_AVAILABLE,Description,Price from food");
