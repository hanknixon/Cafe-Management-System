...
public class ColdDrinks1 extends JFrame implements ActionListener {
    ...
    ColdDrinks1() {
        ...
        try {
            ...
            ResultSet rs = c.s.executeQuery("select COLD_DRINKS_AVAILABLE,Description,Price from colddrinksmenu");
